...
# #try except solves this. I have to add a loop. Need to figure how to loop this part
...
# I'm better understanding how to put loops and which loops to insert to make the code repeat several steps for each file in directory
...
# directory_path = True #?? 
# while directory_path = True #???
## while os.path.isdir() = True: #???       
# We learn"def" after wordposition 3, I need to get help from another TA for a simpler way that use switch type while loop before try except.
# def get_valid_path(is_directory=False):                             # lines 109 - 117 I had assistance writing the code by TA Meher
# reimangine a chunk
...
# right now i get "position of word is st quarter of cheeseshop_sketch.txt"
    # I keep getting "TypeError: TextIOWrapper.write() takes no keyword arguments"
# I need help with writing the results to the file 'wordposition_results.txt    ******

# Need to add more comments throughout on progress as I'm solving this 